...
public class KinomoParser extends Parser {
	...
	public static class CompilationUnitContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).enterCompilationUnit(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).exitCompilationUnit(this);
		}
	}
	...
	public static class VariableContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).enterVariable(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).exitVariable(this);
		}
	}
	...
	public static class PrintContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).enterPrint(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).exitPrint(this);
		}
	}
	...
	public static class ValueContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).enterValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof KinomoListener ) ((KinomoListener)listener).exitValue(this);
		}
	}
